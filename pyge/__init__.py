"""PyGE — a Python game engine. Top-level public surface."""
...
# --- Re-export every glfw.KEY_* constant under the pyge.* namespace --------
...
def dev_tools(app: "App") -> DevTools:
    ...
    existing = getattr(app, "_pyge_dev_tools", None)
    if existing is not None:
        return existing
    tools = DevTools(app)
    app._pyge_dev_tools = tools
    return tools
