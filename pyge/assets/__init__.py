"""Asset pipeline for PyGE: registry, loaders, hot reload, scene save/load."""
...
def setup_assets(app: Any, watch_dirs: list[str] | None = None) -> AssetRegistry:
    ...
    existing = getattr(app, "_pyge_asset_setup", None)
    ...
    renderer_setup = getattr(app, "_pyge_renderer_2d", None)
