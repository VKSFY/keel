...
def _require_imgui():
    ...
    raise ImportError(
        ...
        "PyGE supports the layouts in 1.5.x and 1.6+/1.9x releases.\n"
...
class _ImGuiHost:
    ...
    def begin_frame(
        ...
        *,
        ...
        """Start an ImGui frame, optionally forwarding input from a PyGE InputState.
...
def setup_inspector(app: Any) -> WorldInspector:
    ...
    existing = getattr(app, "_pyge_inspector_setup", None)
    ...
    app._pyge_inspector_setup = setup
